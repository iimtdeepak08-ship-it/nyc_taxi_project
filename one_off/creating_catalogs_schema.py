...
spark.sql("create catalog if not exists nyctaxi managed location 'abfss://unity-catalog-storage@dbstorage77ckxyi26yhpq.dfs.core.windows.net/7405610127272790'")
