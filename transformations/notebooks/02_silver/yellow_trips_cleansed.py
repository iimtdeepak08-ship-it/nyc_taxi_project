...
# DBTITLE 1,Cell 1
from pyspark.sql.functions import col, when, months_between, expr
...
df.write.mode("append").option("mergeSchema", "true").saveAsTable("nyctaxi.02_silver.yellow_trips_cleansed")